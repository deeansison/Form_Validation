...
<header>
    ...
    <!-- ICON -->
        <div class="icon-bar-profile">
            <a href="user.php" ><p id="bck">BACK</p><i class='fa fa-arrow-left faa-horizontal animated '></i></a> 
                ...
                while($row=mysqli_fetch_array($result)){
                            echo"<div class='emp-cont-infos'>";
                                ...
                                echo"<div class='update-buts'>";
                                    ...
                                    //FOR UPDATE EMPLOYEE
                                    echo"<button type='button' class='btn btn-danger edit-security-but' data-toggle='modal' data-target='#myModal'>CHANGE PASSWORD</button>";
                                ...
                                echo"<div class='modal-body mod-body'>";
                                    ...
                                    echo"<form method='post' action='insert.php' enctype='multipart/form-data'>";
                                        echo'<div class="content-password">';
                                            ...
                                            echo'<span class="input input--hoshi">';
                                                echo'<div class="msg-cont">';
                                                    echo'<span id="msg-cont-text-password">Confirm first your old password before the updates</span>';
                                                echo'</div>';
                                                echo"<input id='uname' name='uname' type='hidden' class='form-control' placeholder='User Name' value='".$row['username']."' />";
                                            ...
                                            echo'<span class="input input--hoshi">';
                                                echo'<div class="grp_bts">
                                                    <button type="submit" id="update-password" name="update-password-emp" class="btn btn-danger done-button">UPDATE
                                                    </button>   
                                                </div>';
                                            echo'</span>';
                                    ...
                                    //         echo'<span class="input input--hoshi">';
                                    //             echo'<div class="grp_bts">
                                    //                 <button type="submit" id="update-access" name="update-access-emp" class="btn btn-danger done-button">UPDATE
                                    //                 </button>   
                                    //             </div>';
                                    //         echo'</span>';
        ...
        <div class="col-sm-8 emp-data-box">
            <div class="content2">
                ...
                <!-- <i class="fa fa-filter lck_icon"></i> -->
                        <button type="submit" name="filter" id="filter" class="btn btn-primary filter">
