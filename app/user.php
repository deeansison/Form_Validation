...
<header>
    ...
    <?php
        ...
        session_start();      
        if(isset($_SESSION["password"]) && ($_SESSION["position"]=='Employee')){  
    ...
    <!-- CONT ONE -->
        <div class="user-cont-one">                         
            ...
            <?php
                ...
                while($row=mysqli_fetch_array($result)){
                    ...
                    echo'<div class="p-con">';
                        echo"<p id='usr-name'>".$row['first_name']." ".$row['middle_name']." ".$row['last_name']."</p>";
                        echo"<p id='usr-pos'>".$row['position']."</p>";
                    echo '</div>';
         
                    echo"<input id='statusform' name='statusform' type='hidden' class='form-control' value='".$row['status']."'>";
                    
                    // echo"<input id='ot_req' name='ot_req' type='hidden' class='form-control' value='".$row['OT_request']."'>";
            ...
            <?php
                ...
                echo"   <div class='btns-admin-val'>
                        <a href='employee-profile.php?view=".$row['username']." ' class='btn btn btn-success m-accounts' role='button'>
                    VIEW PROFILE</a>
                    </div>";
                    ...
                    <form action="sendmail.php" method="post" enctype='multipart/form-data'>              
                        ...
                        <div class="content-admin-val">
                            ...
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="text"  id="date_OT" name="date_OT" placeholder="OVERTIME DATE *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="content-admin-val">
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    <div class="msg_cont-admin-val">
                                        <span class='need-admin-val'>FROM (6 PM) TO: </span>
                                    </div>
                                    <input class="input__field input__field--hoshi" type="time" id="time_OT" name="time_OT"  placeholder="TO *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="modal-footer mod-footer-ot-req">
                            <button type='submit' id="sendemail" name="sendemail-user">SEND</button>         
                        </div>
                    </form>
                </div>
                        ...
                        <div class="content-admin-val">
                            ...
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="text"  id="start_date" name="start_date" value="" placeholder="START DATE *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="content-admin-val">    
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="text"  id="end_date" name="end_date" value="" placeholder="END DATE *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="content-admin-val">
                            ...
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <textarea  id="message_leave" name="message_leave" type="text" class="form-control msg-text-field" value="" placeholder="PURPOSE *"  required></textarea> 
                                    </label>    
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="content-admin-val">
                            ...
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="text"  id="date_wfh" name="date_wfh" value="" placeholder="DATE *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="content-admin-val">
                            ...
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="time" id="timein_wfh" name="timein_wfh"  placeholder="TIME *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
                        ...
                        <div class="content-admin-val">
                            <div class="fld-admin-val">
                                <span class="input input--hoshi">
                                    ...
                                    <input class="input__field input__field--hoshi" type="time" id="timeout_wfh" name="timeout_wfh"  placeholder="TIME *" required/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                    </label>    
                                </span>
                            </div>
