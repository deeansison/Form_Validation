...
<header>
    ...
    <div class="icon-bar-ann">
        <a href="all-report.php" ><p id="bck-ann">BACK</p><i class='fa fa-arrow-left faa-horizontal animated'></i></a> 
        ...
        <table class="table-one">
            <thead class="thead-one">
                <tr class="tr-one">
                    ...
                    <th class="th-one">In</th>
                    <th class="th-one">Out</th>
                    <th class="th-one">Status</th>
        ...
        <table id="table">
            <tbody>
                <?php
                    ...
                    time_in_out_backup.add_in_out
                    FROM time_in_out_backup 
                    INNER JOIN user_credentials ON time_in_out_backup.username=user_credentials.username 
                    where  time_in_out_backup.add_in_out='PENDING' AND archive_tinout='' ORDER BY time_in_out_backup.datein DESC";
                    ...
                    while($row=mysqli_fetch_array($result)){
                        ...
                        echo"<td>".$row['add_in_out']."</td> ";
                            echo"<td class='edit-delete-column-body'>";
                                echo"<a id='edit-row' href='time_out_edit.php?inout_ID=" .$row['inout_ID']. " '>
