                ...
                while($row=mysqli_fetch_array($result)){
                            echo"<div class='emp-cont-infos'>";
                                ...
                                echo"<div class='update-buts'>";
                                    ...
                                    //FOR UPDATE INFO
                                    echo "<span><a href='user_update.php?edit=".$row['username']." '>";
                            ...
                            //                 echo'<p><i class="fa fa-exclamation-triangle"></i>
                            //                 DELETE EMPLOYEE '.$row['first_name'].' '.$row['last_name'].' ';
                            //                 echo"<button type='button' class='close' data-dismiss='modal'>&times;</button>";
                            //                 echo'</p>';
                            //             echo"</div>";
      
                            //             echo'<div class="modal-body mod-bod-dlt-emp">';
                            //                 echo'<p>ALL THE RECORDS AND DATA OF THIS EMPLOYEE WILL BE DELETED.</p>';
                        ...
                        echo"<div class='modal-dialog'>";
                            ...
                            echo"<div class='modal-content mod-cont'>";
                                ...
                                echo"<div class='modal-body mod-body'>";
                                    ...
                                    //                 <button type="submit" id="update-uname" name="update-uname" class="btn btn-danger update-button">UPDATE
                                    //                 </button> 
                                    //             </div>';
                                    //         echo'</span>';
                                    //     echo'</div>';
                                    ...
                                    echo"<form method='post' action='insert.php' enctype='multipart/form-data'>";
                                        echo'<div class="content-password">';
                                            ...
                                            echo'<span class="input input--hoshi">';
                                                echo'<div class="msg-cont">';
                                                    echo'<span id="msg-cont-text-password-admin">Confirm first your old password before the updates</span>';
                                                echo'</div>';
                                                echo"<input id='uname' name='uname' type='hidden' class='form-control' placeholder='User Name' value='".$row['username']."' />";
                                                echo'<input class="input__field input__field--hoshi" type="password"  id="password-pass" name="password" autocomplete="off" placeholder="Old Password *" required/>';
                                                echo'<label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">';
                                                    echo'<div class="icon-cont">';
                                            ...
                                            echo'<span class="input input--hoshi">';
                                                echo'<div class="grp_bts">
                                                    <button type="submit" id="update-password" name="update-password" class="btn btn-danger update-button">UPDATE
                                                    </button>   
                                                </div>';
                                            echo'</span>';
                                    ...
                                    //         echo'<span class="input input--hoshi">';
                                    //             echo'<div class="grp_bts">
                                    //                 <button type="submit" id="update-access" name="update-access" class="btn btn-danger update-button">UPDATE
                                    //                 </button>   
                                    //             </div>';
                                    //         echo'</span>';
