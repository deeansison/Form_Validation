...
<header>
    ...
    <div id="clockdate">
        <div class="clockdate-wrapper">
            <div id="clock"></div>
            <div id="date"></div>
            <h6><i class="fa fa-map-marker"></i> Update Account</h6>
        </div>
    </div>
    <!-- END/CLOCK AND DATE -->
...
<?php
    ...
    $result = mysqli_query($db,$sql);
    while($row=mysqli_fetch_array($result)){
    echo'<div class="icon-bar-admin-up">
                            ...
                            echo"<div class='fld2'>";
                                echo"<span class='input input--hoshi'>";
                                    echo"<div class='msg_cont'>";
                                        echo"<span class='need'></span>";
                                    echo"</div>";
                                    echo"<input class='input__field input__field--hoshi' type='text' id='cp' name='cp' placeholder='Company Position *' value='".$row['company_position']."' 
                                    autocomplete='off' list='position-search' required/>";
                                    echo"<label class='input__label input__label--hoshi input__label--hoshi-color-1' for='input-4'>";
                                        echo"<div class='lck'>";
                            ...
                            echo"<div class='fld2'>";
                                echo"<span class='input input--hoshi'>";
                                    echo"<div class='grp_bts'>";
                                        ...
                                        // </button>";
                                        echo"<button type='submit' id='updateButton-user' name='updateButton-user' class='btn btn-danger update-button'>UPDATE
                                        </button>";
                                    echo"</div>";
                                echo"</span>";
                            echo"</div>";
